...
'''def list_notice_student(request, id):

    no_s= Board.objects.get(pk=id)
    notices_s = no_s.notice_set.all()
    return render(request, 'student_notices.html', {'notices_s': notices_s})'''
#@login_required
...
def delete_notice(request, id):
    ...
    #return render(request, 'notices-delete-form.html', {'notice': notice})
